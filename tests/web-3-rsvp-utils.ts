...
export function createConfrimedAttendeeEvent(
  eventID: Bytes,
  attendeeAddress: Address
): ConfrimedAttendee {
  let confrimedAttendeeEvent = changetype<ConfrimedAttendee>(newMockEvent())

  confrimedAttendeeEvent.parameters = new Array()

  confrimedAttendeeEvent.parameters.push(
