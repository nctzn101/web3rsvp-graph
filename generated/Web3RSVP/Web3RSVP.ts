...
export class ConfrimedAttendee extends ethereum.Event {
  get params(): ConfrimedAttendee__Params {
    return new ConfrimedAttendee__Params(this);
  }
}

export class ConfrimedAttendee__Params {
  _event: ConfrimedAttendee;

  constructor(event: ConfrimedAttendee) {
    this._event = event;
  }
